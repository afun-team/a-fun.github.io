...
🧸 에이락 월렛 간단 흐름도
![alt 'A-Fun Blockchain Platform-System Process'](images/afunWalletSimple.png)
<br/>

<h3 id="app-용어">📱 에이락 플랫폼 서비스 연동을 위한 APP 설명</h3>

<br/>

<h5 id="app-용어1">1. 고객사(afunUserApp) APP</h5>

- 고객사에서 에이락 월렛 서비스의 이해를 돕기위해 만들어진 고객사앱 역할의 시뮬레이션 앱입니다.

- 다운로드 경로 : 내부테스트 다운로드 경로이며, 에이락 개발팀에 해당스토어에서 사용하는 계정을 알려주시면 추가해드립니다.

  - Android : https://play.google.com/apps/internaltest/4700616749178142068
  - IOS : 앱 스토어에서 사용하는 계정을 알려주시면 Testflight 초대 메일을 보내드립니다.
  <br/>
  <h5 id="app-용어2">2. Alock Platform APP</h5>

- 고객사에서 에이락 월렛 서비스의 이해를 돕기위해 만들어진 에이락 월렛 역할의 시뮬레이션 앱입니다.

- 다운로드 경로 : 내부테스트 다운로드 경로이며, 에이락 개발팀에 해당스토어에서 사용하는 계정을 알려주시면 추가해드립니다.

  - Android : APK 파일을 보내드립니다.
  - IOS : 앱 스토어에서 사용하는 계정을 알려주시면 Testflight 초대 메일을 보내드립니다.
  <br/>
  <h5 id="app-용어3">3. 에이락 월렛 APP</h5>

- 에이락 플랫폼 서비스가 상용하는 에이락 지갑 앱입니다.

- 다운로드 경로 : 해당하는 기기의 스토어에서 '에이락 월렛'을 검색하여 다운받으시면 됩니다.
...
<br/>
 ...
 <h5 id="-에이락-리워드-플랫폼-api1">1️⃣　고객 정보 등록</h5>
...
<br/>
 <h5 id="-에이락-리워드-플랫폼-api2">2️⃣　고객 지갑 호출</h5>
...
<br/>
 <h5 id="-에이락-리워드-플랫폼-api3">3️⃣　고객 지갑 등록 - 에이락 월렛 내부에서만 사용하는 API 입니다.</h5>
...
<br/>
<h5 id="-에이락-리워드-플랫폼-api4">4️⃣　리워드 지급 요청</h5>
...
<br/>
<h5 id="-에이락-리워드-플랫폼-api5">5️⃣　자산 내역 요청</h5>
...
<h5 id="-에이락-리워드-플랫폼-api6">6️⃣　리워드 지급 내역 요청</h5>
...
<br/>
<h5 id="-에이락-리워드-플랫폼-api7">7️⃣　리워드 지급 상세 내역 요청</h5>
...
<br/>
<h5 id="-에이락-리워드-플랫폼-api8">8️⃣　출금 요청 - 에이락 월렛 내부에서만 사용하는 API 입니다.</h5>
...
<br/>
<h5 id="-에이락-리워드-플랫폼-api9">9️⃣　출금 내역 요청</h5>
...
<br/>
<h5 id="-에이락-리워드-플랫폼-api10">🔟　출금 상세 내역 요청</h5>
